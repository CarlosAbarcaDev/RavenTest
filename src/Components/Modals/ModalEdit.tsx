...
//local type
type TaskStatus = "TODO" | "IN_PROGRESS" | "DONE" | "CANCELLED" | "BACKLOG";
type PointEstimate = "ONE" | "TWO" | "FOUR" | "EIGHT";

const ModalEdit: FC<ModalProps> = ({ isOpen, onClose, taskEdit }) => {
  ...
  useEffect(() => {
    ...
    const estimateMap: Record<PointEstimate, number> = {
      ONE: 1,
      TWO: 2,
      FOUR: 4,
      EIGHT: 8,
    ...
    const estimateValue =
      estimateMap[taskEdit?.pointEstimate as PointEstimate] || 0;
    setEstimateOptionSelected(estimateValue);
    ...
    const statusLabel = statusLabelMap[taskEdit?.status as TaskStatus] || "";
                      ...
                      <div className="w-full flex flex-1 mb-2">
                        <div>
                          <input
                            ...
                            checked={selectedItems?.includes("ANDROID")}
                          />
                        </div>
                        <div className="px-1">
                      ...
                      <div className="w-full flex flex-1 mb-2">
                        <div>
                          <input
                            ...
                            value={"IOS"}
                            onChange={handleCheckboxChange}
                            checked={selectedItems?.includes("IOS")}
                            className="rounded mr-2"
                          />
                        </div>
                        <div className="px-1">
                      ...
                      <div className="w-full flex flex-1 mb-2">
                        <div>
                          <input
                            ...
                            value={"IOS"}
                            onChange={handleCheckboxChange}
                            checked={selectedItems?.includes("NODE_JS")}
                            className="rounded mr-2"
                          />
                        </div>
                        <div className="px-1">
                      ...
                      <div className="w-full flex flex-1 mb-2">
                        <div>
                          <input
                            ...
                            onChange={handleCheckboxChange}
                            className="rounded mr-2"
                            checked={selectedItems?.includes("RAILS")}
                          />
                        </div>
                        <div className="px-1">
